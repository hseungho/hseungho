...
**(주)나눔비타민 Tech Lead / Backend Developer** (2023.07 - )
...
## Careers
- [**(주)나눔비타민**](https://www.nanumnavi.com) (2023.07 - )
  > **Backend Developer** (2023.07 - )  
  > **Tech Lead** (2025.11 -)
  - (주)나눔비타민에서 개발팀장 및 백엔드 플랫폼을 담당하고 있어요
  - 나비얌의 캠페인, 쿠폰, 포인트, 기프트카드, 주문/결제, 정산 등의 도메인을 담당하고 있고,  
    빠르게 성장하는 비즈니스에 맞게 새로운 도메인들도 개발하고 있어요
  - 여러 지자체의 아동급식카드 온라인 결제를 위해 지역별 PG Orchestrator를 구축하였어요
  - 나비얌의 사내 AI 에이전트 및 DB MCP를 개발, 운영하고 있어요  
    Claude API 플랫폼 기반 AI 에이전트이며, DB/Datadog/Amplitude 등의 MCP를 활용하여  
    내부 데이터를 분석해주는 웹 채팅 에이전트를 구축하였어요
  - 빠르게 개발하기 위해 확장성이 높은 소프트웨어 시스템을 설계하기 위해 노력하고  
    다양한 아키텍처와 디자인 패턴들을 적용한 모듈화를 통해  
    유지보수성이 높은 소프트웨어 설계하기 위해 노력하고 있어요
